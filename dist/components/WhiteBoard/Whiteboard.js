...
var initDrawingSettings =
  ((_initDrawingSettings = {
    brushWidth: 5,
    currentMode: 'PENCIL',
    currentColor: '#000000',
  }),
  (_initDrawingSettings['brushWidth'] = 5),
  (_initDrawingSettings.fill = false),
  _initDrawingSettings);
var initSettings = {
  zoom: 1,
  contentJSON: null,
...
var Whiteboard = function Whiteboard(_ref) {
  ...
  var controls = _ref.controls,
    ...
    onSaveCanvasAsImage =
      _ref$onSaveCanvasAsIm === void 0 ? defaultFunction : _ref$onSaveCanvasAsIm,
  ...
  var enabledControls = (0, _react.useMemo)(
    function () {
      var _extends2;
      ...
      return _extends(
        ...
        (_extends2[_BoardClass.modes.LINE] = true),
        (_extends2[_BoardClass.modes.RECTANGLE] = true),
        (_extends2[_BoardClass.modes.ELLIPSE] = true),
        (_extends2[_BoardClass.modes.TRIANGLE] = true),
        (_extends2[_BoardClass.modes.TEXT] = true),
        (_extends2[_BoardClass.modes.SELECT] = true),
        (_extends2[_BoardClass.modes.ERASER] = true),
        (_extends2.CLEAR = true),
        (_extends2.FILL = true),
        (_extends2.BRUSH = true),
        (_extends2.COLOR_PICKER = true),
        (_extends2.DEFAULT_COLORS = true),
        (_extends2.FILES = true),
        (_extends2.SAVE_AS_IMAGE = true),
        (_extends2.GO_TO_START = true),
        (_extends2.SAVE_AND_LOAD = true),
        (_extends2.ZOOM = true),
        (_extends2.TABS = true),
        _extends2),
        controls,
  ...
  (0, _react.useEffect)(
    ...
    [
      fileReaderInfo == null
        ? void 0
        : (_fileReaderInfo$file = fileReaderInfo.file) == null
        ? void 0
        : _fileReaderInfo$file.name,
  ...
  function saveCanvasState() {
    ...
    var newValue = _extends(
      ...
      ((_extends4 = {}),
      (_extends4[fileReaderInfo.file.name] = _extends(
        {},
        canvasObjectsPerPage[fileReaderInfo.file.name],
        ((_extends3 = {}),
        (_extends3[fileReaderInfo.currentPageNumber] = board.canvas.toJSON()),
        _extends3),
      )),
      _extends4),
    );
  ...
  function handleSaveCanvasAsImage() {
    canvasRef.current.toBlob(function (blob) {
      (0,
      _fileSaver.saveAs)(blob, fileReaderInfo.file.name + '-' + (fileReaderInfo.currentPageNumber ? '_page-' : '') + '.png');
  ...
  function onFileChange(event) {
    ...
    var file =
      (_event$target = event.target) == null
        ? void 0
        : (_event$target$files = _event$target.files) == null
        ? void 0
  ...
  var getColorButtons = function getColorButtons(colors) {
    return colors.map(function (color) {
      return /*#__PURE__*/ _react.default.createElement(
        _WhiteboardStyled.ToolbarItemS,
        {
          key: color,
        },
  ...
  var getControls = function getControls() {
    ...
    var modeButtons =
      ((_modeButtons = {}),
      (_modeButtons[_BoardClass.modes.PENCIL] = {
  ...
  return /*#__PURE__*/ _react.default.createElement(
    _WhiteboardStyled.WrapperS,
    null,
    !!enabledControls.TABS &&
      /*#__PURE__*/ _react.default.createElement(
        _WhiteboardStyled.TabsS,
        null,
        Array.from(documents.keys()).map(function (document, index) {
          return /*#__PURE__*/ _react.default.createElement(
            _WhiteboardStyled.TabS,
            {
    ...
    /*#__PURE__*/ _react.default.createElement(
      _WhiteboardStyled.WhiteBoardS,
      {
        ref: whiteboardRef,
      },
      /*#__PURE__*/ _react.default.createElement(
        _WhiteboardStyled.ToolbarHolderS,
        null,
        /*#__PURE__*/ _react.default.createElement(
          _WhiteboardStyled.ColorBarS,
          null,
          ...
          !!enabledControls.BRUSH &&
            /*#__PURE__*/ _react.default.createElement(
              _WhiteboardStyled.ToolbarItemS,
              null,
              /*#__PURE__*/ _react.default.createElement(_WhiteboardStyled.RangeInputS, {
                type: 'range',
                min: 1,
                max: 30,
                step: 1,
        ...
        /*#__PURE__*/ _react.default.createElement(
          ...
          /*#__PURE__*/ _react.default.createElement(_WhiteboardStyled.SeparatorS, null),
      ...
      !!(
        fileReaderInfo != null &&
        (_fileReaderInfo$file2 = fileReaderInfo.file) != null &&
        _fileReaderInfo$file2.size
      ) &&
        /*#__PURE__*/ _react.default.createElement(
          _WhiteboardStyled.PDFWrapperS,
          null,
          /*#__PURE__*/ _react.default.createElement(_PdfReader.PdfReader, {
